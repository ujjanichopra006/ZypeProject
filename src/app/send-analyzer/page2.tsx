    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-r from-blue-200 via-white to-blue-200 flex item-center relative overflow-hidden">
               <div data-aos="fade-up" className=" border-2 text-gray-400 h-100 w-270 px-6 mt-5 flex flex-row mb-5 ml-18 rounded-2xl shadow-2xl">
                ...
                <div data-aos="fade-down" className="w-1/2 px-10 mt-5">
                    <motion.div
                        initial={{ opacity: 0, x: 100 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 1 }}
