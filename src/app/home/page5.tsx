        ...
        <>
            <div className="relative flex flex-col md:flex-row items-center justify-between overflow-hidden bg-gray-100 text-black py-6 md:px-10">
                <div className="bg-white p-6 rounded-2xl shadow-lg flex gap-6">
                    ...
                    <div className="w-1/3 bg-gray-100 p-11 rounded-xl">
                    ...
                    <div className="w-2/3 bg-gray-100 p-4 rounded-xl">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-white text-black p-4 rounded-lg shadow">
                                Get instant personal loans with KeshvaCredit at competitive rates. minimal docs, quick approval & RBI-regulated <br /> Personal Loan
                            </div>

                            <div className="bg-white text-black p-4 rounded-lg shadow">
                                Affordable home loans at competitive interest rates. Quick approval, minimal paperwork, flexible options, and RBI-backed partners. <br />Home Loan
                            </div>

                            <div className="bg-white text-black p-4 rounded-lg shadow">
                                Borrow up to your limit for purchases or bills. Repay monthly. Flexible and secure credit tool for all need. <br />
                                Credit Card
                            </div>

                            <div className="bg-white text-black p-4 rounded-lg shadow">
                                Enjoy smooth transactions, premium perks, cashback and secure RBI-backed loan services. Low interest, high rewards. <br />
                                Business Loan
                            </div>
